...
const PagesTi = Loadable(lazy(() => import('views/pages/saas-pages/Ti')));
const PagesTraining = Loadable(lazy(() => import('views/pages/saas-pages/Training')));
...
const AuthenticationRoutes = {
    ...
    children: [
        ...
        },
        {
            ...
            element: <PagesTraining />
        },
        {
            path: '/service/pentest',
            element: <PagesPentest />
        },
        {
